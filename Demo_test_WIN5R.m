...
load(fullfile(folderModel, ['SWR_N' num2str(noiseSigma) '.mat']));
...
for i = 1:length(filePaths)
  ...
  if isSaveResult
    %% Save 
     ...
     imwrite(im2uint8(output),fullfile(savepath,[nameCur '_recover_WIN5R_N' num2str(noiseSigma) '.bmp']));
   end
end
